...
/**
 * PHAR build script for lphenom/redis.
 *
...
$pharFile = $buildDir . '/lphenom-redis.phar';

if (file_exists($pharFile)) {
    unlink($pharFile);
}

$phar = new Phar($pharFile, 0, 'lphenom-redis.phar');
$phar->startBuffering();
...
$stub = <<<'STUB'
<?php
Phar::mapPhar('lphenom-redis.phar');
require 'phar://lphenom-redis.phar/vendor/autoload.php';
__HALT_COMPILER();
STUB;
